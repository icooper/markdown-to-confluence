...
var comment_1 = __nccwpck_require__(9936);
...
var parse_1 = __nccwpck_require__(1710);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.putContent = exports.getContent = void 0;
var got_1 = __importDefault(__nccwpck_require__(3061));
var ContentUrl = /** @class */ (function () {
    function ContentUrl(url) {
        ...
        if (pathSegments.length >= 6) {
            ...
            throw new Error("URL path does not look like a Confluence page: ".concat(parsed.pathname));
        }
    }
    Object.defineProperty(ContentUrl.prototype, "apiUrl", {
        get: function () {
            return "https://".concat(this.domain, "/wiki/rest/api/content/").concat(this.contentId);
        },
        enumerable: false,
        configurable: true
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 4]);
                    return [4 /*yield*/, got_1.default.get((new ContentUrl(url)).apiUrl, options).json()];
                case 1: return [2 /*return*/, _a.sent()];
                case 2:
                    e_1 = _a.sent();
                    return [4 /*yield*/, e_1.response.json()];
...
function putContent(url, content, options) {
    return __awaiter(this, void 0, void 0, function () {
        var e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 4]);
                    return [4 /*yield*/, got_1.default.put((new ContentUrl(url)).apiUrl, __assign(__assign({}, options), { json: content })).json()];
                case 1: return [2 /*return*/, _a.sent()];
                case 2:
                    e_2 = _a.sent();
...
var missing = [];
if (!workspace)
    missing.push("GITHUB_WORKSPACE");
if (!filename)
    missing.push("INPUT_MARKDOWN");
if (!pageUrl)
    missing.push("INPUT_PAGE");
if (!username)
    missing.push("INPUT_USERNAME");
if (!password)
    missing.push("INPUT_API_KEY");
if (missing.length > 0) {
        ...
        switch (_c.label) {
            ...
            case 2:
                ...
                content = {
                    id: metadata.id,
                    type: metadata.type,
                    title: (_a = doc.title) !== null && _a !== void 0 ? _a : metadata.title,
                ...
                return [4 /*yield*/, (0, confluence_1.putContent)(pageUrl, content, { username: username, password: password })];
            case 3:
                response = _c.sent();
                // print URL of content
                console.log("Markdown rendered to ".concat(response._links.base).concat((_b = response._links) === null || _b === void 0 ? void 0 : _b.webui));
                return [2 /*return*/];
        }
    });
}); })();
...
function toc(exclude) {
    return (0, node_html_parser_1.default)("\n        <img\n            class=\"editor-inline-macro\"\n            data-macro-name=\"toc\"\n            data-macro-parameters=\"exclude=".concat((exclude !== null && exclude !== void 0 ? exclude : "").replace("|", "\\|"), "\"\n            data-macro-schema-version=\"1\"\n        />"));
}
exports.toc = toc;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var marked_1 = __nccwpck_require__(5741);
...
var Transformer = /** @class */ (function () {
    ...
    Transformer.prototype.promoteTitle = function () {
        var title;
        var h1 = this.root.getElementsByTagName("h1");
        if (h1.length === 1) {
            title = h1[0].textContent;
            h1[0].remove();
            var l_1 = 2, hl = [];
            do {
                hl = this.root.getElementsByTagName("h".concat(l_1));
                hl.forEach(function (e) { return e.tagName = "h".concat(l_1 - 1); });
                l_1++;
            } while (hl.length > 0);
        }
        return title;
    };
    Transformer.prototype.addTableOfContents = function () {
        var _a;
        var e = (_a = this.root.getElementById("table-of-contents")) !== null && _a !== void 0 ? _a : this.root.getElementById("table-of-contents-");
        if (e) {
            e.nextElementSibling.replaceWith(macros.toc("(Version\\|".concat(e.textContent, ")")));
        }
    };
    ...
    Transformer.prototype.fixPanels = function () {
        this.root.querySelectorAll("blockquote > p > em").forEach(function (e) {
            var panelType = undefined;
    ...
    Object.defineProperty(Transformer.prototype, "html", {
        get: function () {
